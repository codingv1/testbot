package com.axess.catalogue.config.restapi;

import com.axess.catalogue.exception.*;
...
public class GlobalApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ResponseStatus(value = HttpStatus.BAD_REQUEST)
	@ResponseBody
	protected ResponseEntity<Object> handleJupterException(final MethodArgumentTypeMismatchException ex,
																 WebRequest request) {
		System.out.println("handleJupterException");
		ApiErrorResponse response = new ApiErrorResponse();
