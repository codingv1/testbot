...
#sudo wget -L https://github.com/shankjs/cloud-training/blob/main/smartbank-api-jar/smart-bank-api.jar -O /opt/smart-bank-api.jar
sudo wget https://github.com/shankjs/cloud-training/blob/main/smartbank-api-jar/smart-bank-api.jar?raw=true -O /opt/smart-bank-api.jar
...
sudo java -Dserver.port=3000 -Dspring.datasource.url=jdbc:postgresql://martbank-db.c30n0jmvbfu5.us-west-2.rds.amazonaws.com:5432/smartbank-db -jar /opt/smart-bank-api.jar --logging.file=/home/ec2-user/api/service.log & 
